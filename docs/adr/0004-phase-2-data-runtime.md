...
4. Use Pandera's PyArrow backend for Python-side structural QA, plus deterministic domain checks for OHLC, volume, duplicate keys and point-in-time ordering.
